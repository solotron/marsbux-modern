...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/marsbux
else
  DOCKER_EXEC echo \> \$HOME/.marsbux
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/marsbux/marsbux/pull/18288#discussion_r433189350 for
  # details.
