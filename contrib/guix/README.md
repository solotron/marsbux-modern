# Bootstrappable marsbux Core Builds

This directory contains the files necessary to perform bootstrappable marsbux
Core builds.
...
- 24GB of free disk space on the partition that the marsbux Core git repository
  resides in
...
For a marsbux Core depends development environment, simply invoke
...
From the top of a clean marsbux Core repository:
...
To use dongcarl's substitute server for marsbux Core builds after having
