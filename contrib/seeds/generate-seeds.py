#!/usr/bin/env python3
# Copyright (c) 2014-2021 The marsbux Core developers
...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef marsbux_CHAINPARAMSSEEDS_H\n')
    g.write('#define marsbux_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the marsbux network\n')
    ...
    g.write('#endif // marsbux_CHAINPARAMSSEEDS_H\n')
