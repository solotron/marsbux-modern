...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the marsbux repository."
  exit 1
fi
...
# See https://github.com/marsbux/marsbux/issues/16064
...
echo 'When compiling marsbuxd, run `./configure` in the following way:'
echo
