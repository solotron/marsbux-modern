...
By default, marsbuxd will dump mempool on shutdown and
...
class MempoolPersistTest(marsbuxTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent marsbuxd from writing mempool.dat to disk. Verify that `savemempool` fails")
