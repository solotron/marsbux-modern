...
class TestmarsbuxCli(marsbuxTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `marsbux-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and marsbux-cli getwalletinfo return expected wallet info")
            ...
            # Test marsbux-cli -generate with -rpcwallet in multiwallet mode.
