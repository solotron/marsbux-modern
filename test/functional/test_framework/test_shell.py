...
class TestShell:
    """Wrapper Class for marsbuxTestFramework.

    The TestShell class extends the marsbuxTestFramework
    ...
    class __TestShell(marsbuxTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by marsbuxTestFramework child class.
            self.num_nodes = 1
