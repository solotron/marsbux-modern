...
# Copyright (c) 2010-2020 The marsbux Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""marsbux test framework primitive and message structures
...
# Objects that map to marsbuxd objects, which can be serialized/deserialized


class CAddress:
    __slots__ = ("net", "ip", "nServices", "port", "time")

    # see https://github.com/marsbux/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in marsbuxd
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class CBlockHeader:
    ...
    def calc_sha256(self):
        if self.sha256 is None:
            ...
            self.scrypt256 = uint256_from_str(marsbux_scrypt.getPoWHash(r))
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in marsbuxd indicates these should be deserialized as blocks
