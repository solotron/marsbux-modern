...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the marsbuxTestFramework
    pass


class ExampleTest(marsbuxTestFramework):
    # Each functional test is a subclass of the marsbuxTestFramework class.
    ...
    def custom_method(self):
        ...
        marsbuxTestFramework class so other tests can use it."""
