...
class P2PPermissionsTests(marsbuxTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].marsbuxconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].marsbuxconf, 'w', encoding="utf8") as f:
            f.write(newText)
