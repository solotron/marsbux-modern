...
class WalletLabelsTest(marsbuxTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 marsbuxs
        ...
        for l in BECH32_INVALID:
            ...
            assert_raises_rpc_error(
                -5,
                "Address is not valid" if self.options.descriptors else "Invalid marsbux address or script",
