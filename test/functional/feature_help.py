...
"""Verify that starting marsbux with -h works as expected."""

from test_framework.test_framework import marsbuxTestFramework
from test_framework.util import assert_equal

class HelpTest(marsbuxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start marsbux with -h for help text")
        ...
        self.log.info("Start marsbux with -version for version information")
        ...
        self.log.info("Start marsbuxd with -fakearg to make sure it does not start")
