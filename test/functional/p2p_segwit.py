...
class SegWitTest(marsbuxTestFramework):
    ...
    def test_v0_outputs_arent_spendable(self):
        ...
        for tx in [p2wsh_tx, p2sh_p2wsh_tx]:
            ...
            # marsbux: BTC applied these rules for all transactions once P2SH is enabled, on LTC we enforce
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older marsbuxd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let marsbuxd fill it in.
