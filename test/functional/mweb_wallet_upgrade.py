#!/usr/bin/env python3
# Copyright (c) 2021 The marsbux Core developers
...
class MWEBWalletUpgradeTest(marsbuxTestFramework):
    ...
    def run_test(self):
        ...
        #
        # Create a non-HD wallet using an older marsbux core version
        #
