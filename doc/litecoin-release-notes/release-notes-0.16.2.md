marsbux Core version 0.16.2 is now available from:

  <https://download.marsbux.org/marsbux-0.16.2/>
...
- #12843 `df38b13` Test starting marsbuxd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure marsbuxd processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` marsbuxconsensus: invalid flags should be set to marsbuxconsensus_error type, add test cases covering marsbuxconsensus error codes (Thomas Kerin)
