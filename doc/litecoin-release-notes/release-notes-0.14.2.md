marsbux Core version 0.14.2 is now available from:

  <https://download.marsbux.org/marsbux-0.14.2.0/>
...
marsbux Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in marsbux Core 0.10.4) it has been disabled by default.
...
- http://testnet.marsbuxtools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/marsbux-project/marsbux/blob/master/src/chainparams.cpp#L220).
...
marsbux Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/marsbux-project/marsbux/blob/master/doc/zmq.md) for
...
The Alert System was disabled and deprecated in marsbux Core 0.10.4 and removed in 0.13.2. 
...
here, originally written for marsbux but can also be used for marsbux:
[reducing-marsbuxd-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
