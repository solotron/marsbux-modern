# Fuzzing marsbux Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing marsbux Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/marsbux-project/marsbux
$ cd marsbux/
$ ./autogen.sh
$ CC=clang CXX=clang++ ./configure --enable-fuzz --with-sanitizers=address,fuzzer,undefined
# macOS users: If you have problem with this step then make sure to read "macOS hints for
# libFuzzer" on https://github.com/marsbux/marsbux/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/marsbux-project/marsbux/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/marsbux-project/marsbux/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/marsbux-project/marsbux/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`marsbux-core/qa-assets`](https://github.com/marsbux-core/qa-assets) repo.

To fuzz `process_message` using the [`marsbux-core/qa-assets`](https://github.com/marsbux-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/marsbux-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`marsbux-core/qa-assets`](https://github.com/marsbux-core/qa-assets) repo.

Every single pull request submitted against the marsbux Core repo is automatically tested against all inputs in the [`marsbux-core/qa-assets`](https://github.com/marsbux-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make marsbux Core more robust.
...
with certain assembly code from marsbux Core's code. See [developer notes on sanitizers](https://github.com/marsbux-project/marsbux/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing marsbux Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing marsbux Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing marsbux Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing marsbux Core using [Honggfuzz](https://github.com/google/honggfuzz):

```sh
$ git clone https://github.com/marsbux/marsbux
$ cd marsbux/
$ ./autogen.sh
