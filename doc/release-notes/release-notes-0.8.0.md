marsbux-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/marsbux/files/marsbux/marsbux-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the marsbux
...
New/changed settings (command-line or marsbux.conf file)
--------------------------------------------------------
