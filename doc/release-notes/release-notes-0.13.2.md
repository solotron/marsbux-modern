marsbux Core version 0.13.2 is now available from:
  ...
  <https://marsbux.org/bin/marsbux-core-0.13.2/>
...
- #8908 `4a974b2` Update marsbux-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow marsbux-tx to create v2 transactions (btcdrak)
