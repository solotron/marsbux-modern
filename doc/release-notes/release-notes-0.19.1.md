...
marsbux Core version 0.19.1 is now available from:

  <https://marsbuxcore.org/bin/marsbux-core-0.19.1/>
...
From marsbux Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as marsbux Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, marsbux Core does not yet change appearance when
...
- #17488 fix "marsbuxd already running" warnings on macOS (fanquake)
