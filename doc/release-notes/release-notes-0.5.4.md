marsbux version 0.5.4 is now available for download at:
http://sourceforge.net/projects/marsbux/files/marsbux/marsbux-0.5.4/
...
http://gitorious.org/marsbux/marsbuxd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix marsbux-Qt notifications under Growl 1.3.
Increase required age of marsbux-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxmarsbux properly when installing marsbux-Qt over it. (Windows)
