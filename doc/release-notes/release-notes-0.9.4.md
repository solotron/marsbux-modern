marsbux Core version 0.9.4 is now available from:

  https://marsbux.org/bin/0.9.4/
...
this update is incompatible with the marsbux system and could lead to consensus
forks.

marsbux Core released binaries from https://marsbux.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~marsbux/+archive/ubuntu/marsbux
- A third-party or self-compiled marsbux Core

upgrade to marsbux Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
