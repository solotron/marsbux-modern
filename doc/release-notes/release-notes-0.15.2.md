marsbux Core version *0.15.2* is now available from:

  <https://marsbuxcore.org/bin/marsbux-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in marsbux-tx (TheBlueMatt)
