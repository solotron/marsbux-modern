marsbux Core version 0.10.4 is now available from:

  <https://marsbux.org/bin/marsbux-core-0.10.4/>
...
- #6953 `43c2789` Split marsbux-tx into its own package
- #6953 `dfe0d4d` Include marsbux-tx binary on Debian/Ubuntu
