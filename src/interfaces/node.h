...
#ifndef marsbux_INTERFACES_NODE_H
#define marsbux_INTERFACES_NODE_H
...
//! Top-level interface for a marsbux node (marsbuxd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // marsbux_INTERFACES_NODE_H
