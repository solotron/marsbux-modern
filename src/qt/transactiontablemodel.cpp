...
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label") << marsbuxUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    columns[Amount] = marsbuxUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const WalletTxRecord *wtx, bool showUnconfirmed, marsbuxUnits::SeparatorStyle separators) const
{
    QString str = marsbuxUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->GetNet(), false, separators);
    if(showUnconfirmed)
    {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, marsbuxUnits::SeparatorStyle::ALWAYS);
        }
        break;
    case Qt::EditRole:
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, marsbuxUnits::SeparatorStyle::NEVER));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, marsbuxUnits::SeparatorStyle::NEVER);
    case StatusRole:
