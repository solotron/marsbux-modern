...
#ifndef marsbux_QT_TRANSACTIONTABLEMODEL_H
#define marsbux_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const WalletTxRecord *wtx, bool showUnconfirmed=true, marsbuxUnits::SeparatorStyle separators=marsbuxUnits::SeparatorStyle::STANDARD) const;
...
#endif // marsbux_QT_TRANSACTIONTABLEMODEL_H
