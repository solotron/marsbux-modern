...
#ifndef marsbux_QT_GUIUTIL_H
#define marsbux_QT_GUIUTIL_H
...
/** Utility functions used by the marsbux Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "marsbux:" URI into recipient object, return true on successful parsing
