    ...
    mapper(nullptr)
{
    ...
    ui->marsbuxAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->marsbuxAtStartup);
    ...
    ui->marsbuxAtStartup->setToolTip(ui->marsbuxAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->marsbuxAtStartup->setText(ui->marsbuxAtStartup->text().arg(PACKAGE_NAME));

    ui->openmarsbuxConfButton->setToolTip(ui->openmarsbuxConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new marsbuxUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->marsbuxAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openmarsbuxConfButton_clicked()
{
