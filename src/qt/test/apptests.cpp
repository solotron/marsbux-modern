...
//! Entry point for marsbuxApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &marsbuxApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for marsbuxGUI tests.
void AppTests::guiTests(marsbuxGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &marsbuxGUI::consoleShown, this, &AppTests::consoleTests);
