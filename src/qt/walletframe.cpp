...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, marsbuxGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &marsbuxGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &marsbuxGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &marsbuxGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &marsbuxGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &marsbuxGUI::updateWalletStatus);
    connect(gui, &marsbuxGUI::setPrivacy, walletView, &WalletView::setPrivacy);
