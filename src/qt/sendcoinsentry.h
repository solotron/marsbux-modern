...
#ifndef marsbux_QT_SENDCOINSENTRY_H
#define marsbux_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending marsbuxs.
...
#endif // marsbux_QT_SENDCOINSENTRY_H
