    ...
    platformStyle(_platformStyle)
{
    ...
    // normal marsbux address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying marsbux address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &marsbuxAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
