...
#ifndef marsbux_SCRIPT_STANDARD_H
#define marsbux_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a marsbux address
 */
...
/**
 * Generate a marsbux scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // marsbux_SCRIPT_STANDARD_H
