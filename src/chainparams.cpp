...
// Copyright (c) 2017-2026 MarsBux Technologies, LLC

// Code for MarsBux (MARS) cryptocurrency
...
{
    // const char* pszTimestamp = "NY Times 05/Oct/2011 Steve Jobs, Apple’s Visionary, Dies at 56"; // MarsBux mod - changed on next line
    const char* pszTimestamp = "mars genesis block"; // MarsBux mod - use original value
    // const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG; // Marsbux mod - changed immediately below
    // MarsBux mod - use original value on following line
...
public:
    CMainParams() {
        ...
        consensus.signet_blocks = false; // MarsBux mod - no change needed
        consensus.signet_challenge.clear(); // MarsBux mod - no change needed
        // consensus.nSubsidyHalvingInterval = 840000; // MarsBux mod - changed on next line
        consensus.nSubsidyHalvingInterval = 500000; // MarsBux mod - custom halving
        consensus.BIP16Height = 218579; // 87afb798a3ad9378fcd56123c81fb31cfd9a8df4719b9774d71730c16315a092 - October 1, 2012
        // consensus.BIP34Height = 710000; // MarsBux mod - changed on next line
        consensus.BIP34Height = 0; // MarsBux mod
        ...
        pchMessageStart[0] = 0xdb; // MarsBux mod
        pchMessageStart[1] = 0x47; // MarsBux mod
        pchMessageStart[2] = 0x75; // MarsBux mod
        pchMessageStart[3] = 0x24; // MarsBux mod
        nDefaultPort = 9333; // MarsBux mod - no change needed
        nPruneAfterHeight = 100000; // MarsBux mod - no change needed
        ...
        // vSeeds.emplace_back("seed-a.marsbux.loshan.co.uk"); // MarsBux mod - don't think we want these
        // vSeeds.emplace_back("dnsseed.thrasher.io");          // MarsBux mod - ditto
        // vSeeds.emplace_back("dnsseed.marsbuxtools.com");    // MarsBux mod - ditto
        // vSeeds.emplace_back("dnsseed.marsbuxpool.org");     // MarsBux mod - ditto
        // vSeeds.emplace_back("dnsseed.koin-project.com");     // MarsBux mod - ditto
        vSeeds.emplace_back("seed.marsbux.solotron"); // MarsBux mod - Add real seeds later

        // base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48); // MarsBux mod - use value on next line
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);  // MarsBux mod - 0x32 → "M"
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5); // MarsBux mod - no change needed?
        ...
        // bech32_hrp = "ltc";
        // mweb_hrp = "ltcmweb";
        bech32_hrp = "mars"; // MarsBux mod
        mweb_hrp = "marsmweb"; // MarsBux mod
        ...
        */
        ...
        // MarsBux mod - Checkpoints (replace whole block)
        checkpointData = {
            {
                {0, uint256S("0x2c890f2275e83be13bbd209cafa234204926454e6442ccf56cae8232ad6124f7")},
                {1, uint256S("0x72b4029ab084a808fec2e6dc2b1341f3fd0bf18e3451b5fb0026849da79df4dc")}
            }
        };
...
public:
    CTestNetParams() {
        ...
        // pchMessageStart[0] = 0xfd; // Marsbux mod
        // pchMessageStart[1] = 0xd2; // Marsbux mod
        // pchMessageStart[2] = 0xc8; // MarsBux mod
        // pchMessageStart[3] = 0xf1; // MarsBux mod
        pchMessageStart[0] = 0xe1; // MarsBux mod - random
        pchMessageStart[1] = 0xf2; // MarsBux mod - random
        pchMessageStart[2] = 0xa3; // MarsBux mod - random
        pchMessageStart[3] = 0xb4; // MarsBux mod - random
        // nDefaultPort = 19335; // MarsBux mod
        nDefaultPort = 9333;  // MarsBux mod - our P2P
        // nPruneAfterHeight = 1000; // MarsBux mod - use value on next line
        nPruneAfterHeight = 100000; // MarsBux mod
        ...
        // vSeeds.emplace_back("testnet-seed.marsbuxtools.com"); // MarsBux mod
        // vSeeds.emplace_back("seed-b.marsbux.loshan.co.uk"); // MarsBux mod
        // vSeeds.emplace_back("dnsseed-testnet.thrasher.io"); // MarsBux mod
        vSeeds.emplace_back("seed.marsbux.solotron"); // MarsBux mod - Add real seeds later
        ...
        // bech32_hrp = "tltc";
        // mweb_hrp = "tmweb";
        bech32_hrp = "tmars"; // MarsBux mod
        mweb_hrp = "tmarsmweb"; // MarsBux mod
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // Marsbux mod - mapCheckpoints not found - so modifying checkpointData
        /*
        checkpointData = {
            {
        ...
        */
        // MarsBux mod follows but using variable checkpointData instead of mapCheckpoints
        checkpointData = {
            {
                {0, uint256S("0x2c890f2275e83be13bbd209cafa234204926454e6442ccf56cae8232ad6124f7")},
                {1, uint256S("0x72b4029ab084a808fec2e6dc2b1341f3fd0bf18e3451b5fb0026849da79df4dc")}
