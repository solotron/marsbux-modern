...
#ifndef marsbux_COMPAT_ASSUMPTIONS_H
#define marsbux_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "marsbux cannot be compiled without assertions."
#endif
...
#endif // marsbux_COMPAT_ASSUMPTIONS_H
