...
#ifndef marsbux_RPC_PROTOCOL_H
#define marsbux_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in marsbuxd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< marsbux is not connected
