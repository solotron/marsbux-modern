 ...
 * for both marsbuxd and marsbux-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("marsbuxCore");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/marsbux/bips/blob/master/bip-0014.mediawiki)
 */
