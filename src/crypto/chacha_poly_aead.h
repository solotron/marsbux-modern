...
#ifndef marsbux_CRYPTO_CHACHA_POLY_AEAD_H
#define marsbux_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@marsbux.
 *
 ...
 *
 * The chacha20-poly1305@marsbux combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@marsbux cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@marsbux are relatively fast in
...
#endif // marsbux_CRYPTO_CHACHA_POLY_AEAD_H
