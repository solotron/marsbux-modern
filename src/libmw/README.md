...
Modular library for supporting marsbux's implementation of the MWEB (Mimblewimble Extension Block). 
...
### crypto/
Crypto libraries not provided by marsbux or secp256k1-zkp.
...
While boost\:\:filesystem is already pulled in by marsbux, I was uncomfortable with its API and its handling of unicode conversions.
...
which was built on top of https://github.com/marsbux/marsbux/tree/master/src/secp256k1
...
and just replace the more-limited secp256k1 dependency that's already included in marsbux.
