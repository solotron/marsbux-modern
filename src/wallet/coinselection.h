// Copyright (c) 2017-2018 The marsbux Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef marsbux_WALLET_COINSELECTION_H
#define marsbux_WALLET_COINSELECTION_H
...
#endif // marsbux_WALLET_COINSELECTION_H
