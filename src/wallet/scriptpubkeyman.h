...
#ifndef marsbux_WALLET_SCRIPTPUBKEYMAN_H
#define marsbux_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The marsbux Core wallet was originally a collection of unrelated private
...
#endif // marsbux_WALLET_SCRIPTPUBKEYMAN_H
