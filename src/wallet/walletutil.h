...
#ifndef marsbux_WALLET_WALLETUTIL_H
#define marsbux_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! marsbux from opening the wallet, thinking it was newly created, and
...
#endif // marsbux_WALLET_WALLETUTIL_H
