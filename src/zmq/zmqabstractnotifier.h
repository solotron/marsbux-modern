// Copyright (c) 2015-2018 The marsbux Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef marsbux_ZMQ_ZMQABSTRACTNOTIFIER_H
#define marsbux_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // marsbux_ZMQ_ZMQABSTRACTNOTIFIER_H
