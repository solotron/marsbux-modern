/* src/config/marsbux-config.h.  Generated from marsbux-config.h.in by configure.  */
/* src/config/marsbux-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef marsbux_CONFIG_H

#define marsbux_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The marsbux Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "marsbux Core"
...
#define PACKAGE_BUGREPORT "https://github.com/marsbux-project/marsbux/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "marsbux Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "marsbux Core 0.21.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "marsbux"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://marsbux.org/"
