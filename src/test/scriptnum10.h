...
#ifndef marsbux_TEST_SCRIPTNUM10_H
#define marsbux_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from marsbux Core 0.10.0, for cross-comparison.
 */
public:
