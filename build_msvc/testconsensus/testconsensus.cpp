...
// marsbux includes.
#include <..\src\script\marsbuxconsensus.h>
...
int main()
{
    std::cout << "marsbuxconsensus version: " << marsbuxconsensus_version() << std::endl;
    ...
    auto op0Result = marsbuxconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, marsbuxconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
